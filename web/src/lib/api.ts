...
export async function createExpense(
  ...
  // gastito: provenance for bot-created expenses (source="whatsapp",
  // externalId=Gowa message id). Omitted for manual/UI expenses.
  provenance?: { source?: string; externalId?: string },
): Promise<Expense> {
